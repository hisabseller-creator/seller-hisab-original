...
export function WebsiteHeader(){
 ...
 </div><nav className="website-mobile-tabs" aria-label="Website navigation tabs">{navLinks}<Link href="/app" aria-current={pathname?.startsWith('/app')?'page':undefined}>{user?(english?'My account':'मेरा अकाउंट'):(english?'Log in':'लॉग इन')}</Link></nav></header>;
}
